...
public class FXMLDocumentController  implements Initializable {
  ...
  private static  Connection connexion;
   ...
   @FXML public  void Conncet(ActionEvent event) throws SQLException, IOException {
       ...
       PreparedStatement prepStat=connexion.prepareStatement("select user,pass from Admin where user=? and pass=?");
       prepStat.setString(1,user.getText());
       prepStat.setString(2,passwd.getText());
