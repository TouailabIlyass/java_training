...
<link href="http://localhost:8000/tawfik/simple-line-icons/css/simple-line-icons.css" rel="stylesheet" type="text/css">
    ...
    <link href="http://localhost:8000/tawfik/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link href="https://fonts.googleapis.com/css?family=Montserrat:400,700" rel="stylesheet" type="text/css">
    <link href='https://fonts.googleapis.com/css?family=Kaushan+Script' rel='stylesheet' type='text/css'>
    <link href='https://fonts.googleapis.com/css?family=Droid+Serif:400,700,400italic,700italic' rel='stylesheet' type='text/css'>
    <link href='https://fonts.googleapis.com/css?family=Roboto+Slab:400,100,300,700' rel='stylesheet' type='text/css'>
    <link href="http://localhost:8000/tawfik/css/agency.css" rel="stylesheet">
                ...
                <div class="col-md-5 col-lg-4 col-sm-6 rounded border shadow p-3 mb-5 bg-white " id="col-Login" >
                            ...
                            <form  method="POST" action="login" id="formlogin">
                                ...
                                <div class="form-group ">
                                    <label >E-mail</label>
                                    <input id="email" type="text" name="email" class="form-control" placeholder="E-mail" required autofocus>  
 ...
 <script src="js/jq.min.js"></script>
    ...
    <script>
     $(document).ready(function(){
         /*
                 var url="http://localhost/ldap/test.php";
                
                $("#login").click(function(e) {
                    e.preventDefault();
                  
                   var data={'user':'iiii','pass':'iiiii'};
