...
public class UpdateUserController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
            ...
            if (users.isEmpty()) {
                ...
                ListView.setOnMouseClicked((l) -> {
                    if (!ListView.getSelectionModel().isEmpty()) {
                        initU(users.get(ListView.getSelectionModel().getSelectedIndex()));
                        ...
                        KeyFrame openW = new KeyFrame(Duration.millis(500), new KeyValue(First.layoutXProperty(), Main.getLayoutX(), Interpolator.EASE_BOTH));
        ...
        BackM.setOnMouseClicked((e) -> {
            Timeline changeW = new Timeline();
            KeyFrame closeW = new KeyFrame(Duration.millis(500), new KeyValue(First.layoutXProperty(), 776, Interpolator.EASE_BOTH));
            KeyFrame openW = new KeyFrame(Duration.millis(500), new KeyValue(Main.layoutXProperty(), First.getLayoutX(), Interpolator.EASE_BOTH));
            changeW.getKeyFrames().addAll(closeW, openW);
            changeW.play();
        });
        ...
        Next.setOnMouseClicked((e) -> {
            Timeline changeW = new Timeline();
            KeyFrame closeW = new KeyFrame(Duration.millis(500), new KeyValue(First.layoutXProperty(), -776, Interpolator.EASE_BOTH));
            KeyFrame openW = new KeyFrame(Duration.millis(500), new KeyValue(Secend.layoutXProperty(), First.getLayoutX(), Interpolator.EASE_BOTH));
            changeW.getKeyFrames().addAll(closeW, openW);
            changeW.play();
        });

        BackF.setOnMouseClicked((e) -> {
            Timeline changeW = new Timeline();
            KeyFrame closeW = new KeyFrame(Duration.millis(500), new KeyValue(Secend.layoutXProperty(), 776, Interpolator.EASE_BOTH));
            KeyFrame openW = new KeyFrame(Duration.millis(500), new KeyValue(First.layoutXProperty(), Secend.getLayoutX(), Interpolator.EASE_BOTH));
            changeW.getKeyFrames().addAll(closeW, openW);
            changeW.play();
        });
        ...
        NextL.setOnMouseClicked((e) -> {
            Timeline changeW = new Timeline();
            KeyFrame closeW = new KeyFrame(Duration.millis(500), new KeyValue(Secend.layoutXProperty(), -776, Interpolator.EASE_BOTH));
            KeyFrame openW = new KeyFrame(Duration.millis(500), new KeyValue(LAST.layoutXProperty(), Secend.getLayoutX(), Interpolator.EASE_BOTH));
            changeW.getKeyFrames().addAll(closeW, openW);
            changeW.play();
        });
        ...
        BackS.setOnMouseClicked((e) -> {
            ...
            KeyFrame openW = new KeyFrame(Duration.millis(500), new KeyValue(Secend.layoutXProperty(), LAST.getLayoutX(), Interpolator.EASE_BOTH));
            changeW.getKeyFrames().addAll(closeW, openW);
            changeW.play();
        });
        ...
        UPDATE.setOnMouseClicked((e) -> {
            if (Firstname.validate() && Lastname.validate() && BrithPlace.validate() && CIN.validate() && Phone.validate() && Username.validate() && Password.validate() && Password1.validate() && (BrithDate.getValue() != null)) {
                if (!Password.getText().equals(Password1.getText())) {
                    ...
                    user.setID(AdminsUsers.getUsers(FirstnameF.getText()).get(ListView.getSelectionModel().getSelectedIndex()).getID());
                    AdminsUsers.prsDelete(user.getID());
    ...
    private void initU(Users user) {
        Firstname.setText(user.getFirstname());
        Lastname.setText(user.getLastname());
        BrithPlace.setText(user.getBrith_Place());
        BrithDate.setValue(user.getBrith_Date().toLocalDate());
        CIN.setText(user.getCIN());
        Phone.setText(user.getPhone());
        Email.setText(user.getEmail());
        Position.setText(user.getPosition());
        Username.setText(user.getUsername());
        Password.setText(user.getCode());
        Password1.setText(user.getCode());
        AU.setSelected(user.getPermissionMU().isAddUser());
        RU.setSelected(user.getPermissionMU().isRemoveUser());
        UU.setSelected(user.getPermissionMU().isUpdateUser());
        listA.getItems().clear();
        listA.getItems().add(new CustomizedItem1("", "", "", "", "", "", "", "", "", "", "", "", "", false));
        managerStudents = AdminsUsers.getAcesse(user.getUsername());
        managerStudents.forEach((ms) -> {
            listA.getItems().add(ms);
        });
    }
