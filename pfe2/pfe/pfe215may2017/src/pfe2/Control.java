...
{     
     ...
     y=CalculDistance(l, axe, f1.getLayoutX(), op.getStartX(),true);
     l.setEndX(y);
   ...
   //R2.setStartX(mil+dist2);R2.setEndX(mil+dist2);
     ...
     if (angle < 0)
         ...
         y=f1.getLayoutY()+Math.sin(angle)*dist;
     
     while(y<l7.getEndY())
     { dist++;
     	y=f1.getLayoutY()+Math.sin(angle)*dist;
       if(y>l7.getEndY()) break;
     }
     l5.setEndY(y);
     l5.setEndX(f1.getLayoutX()+Math.cos(angle)*dist);
     //////////////////////////////////////////////////
    ...
    arc3.setLayoutY(l7.getEndY()-26);
              ...
              System.out.println("l7 "+l7.getEndY());
              System.out.println("l5 "+l5.getEndY());
              
              System.out.println("pfe2.Control.Calculer()");
  ...
  private  void ClickBtn(MouseEvent e) throws IOException  {
      ...
      public void ChangeToLentille()
    {
      ...
      private double CalculDistance(Line l1,Line l2,double start,double end,boolean flag)
      {
          int dist=1;
