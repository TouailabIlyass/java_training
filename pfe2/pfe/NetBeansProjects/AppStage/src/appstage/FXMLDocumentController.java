...
public class FXMLDocumentController  implements Initializable {
  ...
  private static  Connection connexion;
   ...
   @FXML public  void Conncet(ActionEvent event) throws SQLException, IOException, InterruptedException {
          int id=1;
    
       PreparedStatement prepStat=connexion.prepareStatement("select user,passwd from Admin where id= ?");
