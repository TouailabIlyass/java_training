  ...
  private static  Connection connexion;
   ...
   @FXML private void Valide (ActionEvent event) throws SQLException {
     ...
     int  e=EntiteList.indexOf(SCE.getValue())+1;
       ...
       prepStat=connexion.prepareStatement("UPDATE Besion SET DA=?,Type=?,DateAffec=?,SCE=?,Estimation=?,ChefProjet=?,Objet=? WHERE NumDossier=?");
       ...
       prepStat.executeUpdate();
       ///////////////////////////////////////////////////////
       prepStat=connexion.prepareStatement("UPDATE RFI SET NumRFI=?,Date=?,Echeange=?  WHERE NumDossier=?");
      ...
      prepStat.setDate(3, MyException.StringToDate(RFIEcheance.getValue()));
       ...
       prepStat.executeUpdate();
       ////////////////////////////////////
        prepStat=connexion.prepareStatement("UPDATE CGAO SET NumPV=?,Date=?  WHERE NumDossier=?");
        ...
        prepStat.executeUpdate();
        ////////////////////////////////////
        prepStat=connexion.prepareStatement("UPDATE AO SET  NumAO=?,DateAO=?,Echeange=?,Relance=?  WHERE NumDossier=?");
        ...
        prepStat.executeUpdate();
          ////////////////////////////////////
        prepStat=connexion.prepareStatement("UPDATE COF SET DateTech=?,DateAvis=?,DateCom=?  WHERE NumDossier=?");
        ...
        prepStat=connexion.prepareStatement("UPDATE AE SET NumAE=?,idNature=?,Annee=?,MontantAE=?,MontantEngage=?,DateAE=?,DateArrive=?  WHERE NumDossier=?");
        ...
        prepStat=connexion.prepareStatement("UPDATE CAD SET PVNum=?,DateCAD=?,Signataire=?,Adjudicataire=?,Origine=?,NumCDE=?,DateCDE=?,SignataireCDE=?,Delai=?,Montant=?,Situation=?,Observation=? WHERE NumDossier=?");
