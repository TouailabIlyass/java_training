...
public  StringProperty     NumDossier,TitreDossier,Acheteur,Entite,BesionType,NDA,DateAffec,SCE,Estimation,ChefProjet,Objet,NRFI,DateRFI,RFIEcheance,CGAONPV,
    ...
    {
       return NumDossier.getValue()+"  "+TitreDossier.getValue()+"  "+Acheteur.getValue()+"  "+Entite.getValue()+"  "+BesionType.getValue()+"  "+NDA.getValue()+"  "+DateAffec.getValue()+"  "+SCE.getValue()+"  "+Estimation.getValue()+"  "+ChefProjet.getValue()+"  "+
                Objet.getValue()+"  "+NRFI.getValue()+"  "+DateRFI.getValue()+"  "+RFIEcheance.getValue()+"  "+CGAONPV.getValue()+"  "+DateCGAO.getValue()+"  "+NAO.getValue()+"  "+DateAO.getValue()+"  "+
                AOEcheance.getValue()+"  "+AORelance.getValue()+"  "+COFDateTech.getValue()+"  "+COFDateAvis.getValue()+"  "+COFDateCom.getValue()+"  "+
                AENature.getValue()+"  "+AEAnnee.getValue()+"  "+AEMontant.getValue()+"  "+AEMontEnagage.getValue()+"  "+AEDate.getValue()+"  "+NAE.getValue()+"  "+AEDateArrivee.getValue()+"  "+
               CADPVNum.getValue()+"  "+CADDate.getValue()+ "  "+CADSignataire.getValue()+ "  "+CADAdjucataire.getValue()+ "  "+CADOrigine.getValue()+ "  "+CDENum.getValue()+ "  "+CDEDate.getValue()+ "  "+CDESignataire.getValue()+ "  "+CDEDelai.getValue()+ "  "+
               CADMontant.getValue()+"  "+CADSituation.getValue()+ "  "+CADObservation.getValue();
