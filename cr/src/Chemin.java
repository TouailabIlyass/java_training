...
public class Chemin extends JFrame {
	...
	public Chemin() {
		EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    BufferedImage img = ImageIO.read(new File("images/chemin.png"));
                    ...
                    carrfour.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                    BufferedImage red_car = ImageIO.read(new File("images/red.png"));
                    BufferedImage pink_car = ImageIO.read(new File("images/pink.png"));
                    BufferedImage green_car = ImageIO.read(new File("images/green.png"));
                    BufferedImage turqoise_car = ImageIO.read(new File("images/turqoise.png"));
                    BufferedImage but = ImageIO.read(new File("images/button.png"));
