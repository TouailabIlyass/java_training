   ...
   public void initialize(URL arg0, ResourceBundle arg1) {
	...
	hamb = new HamburgerBackArrowBasicTransition(hamburger);
       ...
       lblFoyer.setLayoutY(f1.getLayoutY()+10);
        ...
        for (int i = 0; i < 200; i++,x+=9) {
           listLine.add(new Line(0, x, 700, x));
           listLine.get(i).setId("grid");
           listLine.get(i).toBack();
           pan.getChildren().add(listLine.get(i));
     }
//        double xy=0;
//        double cm=0.026;
//        ArrayList<Line> listLine1=new ArrayList<Line>();
//        for (int i = 0; i < 200; i++,xy+=cm*39) {
//           listLine1.add(new Line(xy, 0, xy, 390));
//           listLine1.get(i).setId("grid");
//           pan.getChildren().add(listLine1.get(i));
//     }
           double cm=0.026;
           int t=(int) (cm*38.48);
  Line ln=new Line(0, 0,0, 200);
  Line lm=new Line(38.46, 0,38.46, 200);
  ln.setId("grid");
  lm.setId("grid");
  pan.getChildren().addAll(ln);
  pan.getChildren().addAll(lm);
//  ln=new Line(0, 8, 200, 8);ln.setId("grid");pan.getChildren().addAll(ln);
//   ln=new Line(0, 12, 200, 12);ln.setId("grid");pan.getChildren().addAll(ln);
//        ln=new Line(0, 16, 200, 16);ln.setId("grid");pan.getChildren().addAll(ln);
//<ImageView fx:id="img" fitHeight="600.0" fitWidth="800.0" layoutX="-2.0" layoutY="-1.0" pickOnBounds="true">
//               <image>
//                  <Image url="@a5.png" />
//               </image>
//            </ImageView>
   ...
   public void ClickHamburger(MouseEvent e){
    ...
    public void Close() {
        ...
        System.err.println("jjjjj"+hamb.getRate());
        hamb.play();
...
{     
 		...
 		DrawConvergente();
          ...
          {     
              ...
              double mil=((axe.getEndX()-10)/2.0);
               ...
               lbl.setText("Objet : "+String.valueOf(((mil-R.getStartX())*cm)).substring(0, 4)+" cm");
               lbl1.setText("foyer : "+String.valueOf(((mil-f1.getLayoutX())*cm)).substring(0, 4)+" cm");
               lblFoyer.setLayoutX(f1.getLayoutX()+10);
                lblFoyer.setLayoutY(f1.getLayoutY()+10);
                 lblObjet.setLayoutX(arc.getLayoutX()+10);
                lblObjet.setLayoutY(arc.getLayoutY()+10);
 ...
 public static Point lineIntersect(int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4) {
  ...
  public void Init()
  {
     ...
     lbl1.setLayoutY(stg.getHeight()-70);
